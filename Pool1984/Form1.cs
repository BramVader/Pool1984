...
using Ajv.Pool1984.Exporters;
using Ajv.Pool1984.Properties;
using System;
...
namespace Ajv.Pool1984
{
    public partial class Form1 : Form
    {
        ...
        private static readonly Number[] numbers = new Number[]
        {
        ...
        private static readonly PointF[][][] boxes = new PointF[][][]
        {
            // Boxes on Ball 1
            new PointF[][]
            {
        ...
        private static readonly Dictionary<string, BallPosition> positions = new[]
        {
        ...
        private static readonly SpotLight[] lights = new SpotLight[]
        {
            new SpotLight
            {
                Spots = new SpotLight.Spot[]
                {
                    new SpotLight.Spot { TargetPosition = "Ball 1", PixelCenter = new PointF(78.76f, 197.04f), PixelSize1 = new SizeF(3.75f, 5.14f), PixelSize2 = new SizeF(6.62f, 9.12f), Degrees = 40f },
                    new SpotLight.Spot { TargetPosition = "Ball 4a", PixelCenter = new PointF(645.37f, 151.28f), PixelSize1 = new SizeF(4.38f, 5.85f), PixelSize2 = new SizeF(6.98f, 8.64f), Degrees = 60f },
                }
            },
            ...
            new SpotLight
            {
                Spots = new SpotLight.Spot[]
                {
                    new SpotLight.Spot { TargetPosition = "Ball 1", PixelCenter = new PointF(89.39f, 168.44f), PixelSize1 = new SizeF(11.17f, 10.74f), PixelSize2 = new SizeF(13.96f, 13.86f), Degrees = 60f },
                    new SpotLight.Spot { TargetPosition = "Ball 4a", PixelCenter = new PointF(655.59f, 125.47f), PixelSize1 = new SizeF(10.02f, 9.31f), PixelSize2 = new SizeF(12.83f, 12.11f), Degrees = 62.1f },
                }
            },
            ...
            new SpotLight
            {
                Spots = new SpotLight.Spot[]
                {
                    new SpotLight.Spot { TargetPosition = "Ball 1", PixelCenter = new PointF(120.31f, 129.81f), PixelSize1 = new SizeF(7.31f, 8.84f), PixelSize2 = new SizeF(9.97f, 11.56f), Degrees = 75f },
                    new SpotLight.Spot { TargetPosition = "Ball 4a", PixelCenter = new PointF(683.08f, 85.47f), PixelSize1 = new SizeF(8.22f, 10.21f), PixelSize2 = new SizeF(10.37f, 12.35f), Degrees = 80f },
                }
            }
        };

        // ColorRef areas are used for color calibration
        private static readonly ColorRef[] colorRefs = new ColorRef[] {
        ...
        private static readonly Keyframe[] keyframes = new Keyframe[] {
        ...
        private readonly Bitmap pictureDetail;

        private readonly Bitmap renderBitmap;
        private readonly CubeTexture cubeMap;

        private readonly Model model;
        private readonly Camera viewCamera;
        private readonly Dictionary<string, Primitive> primitives;
        private readonly Dictionary<string, Ball> balls;

        private readonly Vector3[] pictureRect = new Vector3[4];
        private readonly float pictureScale = 1f;
        private readonly float pictureWidth, pictureHeight;

        private readonly RectangleF pictureDetailRect = new RectangleF(650f, 56f, 96f, 77f);
        ...
        private void CalcScene()
        {
            ...
            foreach (var ball in balls.Values)
            {
                ...
                if (number != null)
                {
                    ...
                    rot *= Matrix4.RotateY(textureOrientation.Y);
        ...
        {
            var raytracer = new MyRaytracer(2, 2, renderBitmap.Width, renderBitmap.Height, model);
        ...
        internal static Keyframe[] Keyframes => keyframes;
        ...
        private async void RenderButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var raytracer = new MyRaytracer(model.NrSamplesX, model.NrSamplesY, renderBitmap.Width, renderBitmap.Height, model);
                IProgress<MyRaytracer.Line> progress = new Progress<MyRaytracer.Line>(line =>
                {
